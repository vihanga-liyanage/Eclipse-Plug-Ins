 ...
 */
package org.xtext.example.student.student.impl;
...
import org.xtext.example.student.student.Address;
import org.xtext.example.student.student.Model;
import org.xtext.example.student.student.Student;
import org.xtext.example.student.student.StudentFactory;
import org.xtext.example.student.student.StudentPackage;
 ...
 * @generated
 */
public class StudentPackageImpl extends EPackageImpl implements StudentPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.student.student.StudentPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private StudentPackageImpl()
  {
    super(eNS_URI, StudentFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link StudentPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static StudentPackage init()
  {
    if (isInited) return (StudentPackage)EPackage.Registry.INSTANCE.getEPackage(StudentPackage.eNS_URI);

    // Obtain or create and register package
    StudentPackageImpl theStudentPackage = (StudentPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof StudentPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new StudentPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theStudentPackage.createPackageContents();

    // Initialize created meta-data
    theStudentPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theStudentPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(StudentPackage.eNS_URI, theStudentPackage);
    return theStudentPackage;
  }
   ...
   * @generated
   */
  public EReference getStudent_Address()
  {
  ...
  {
    return (StudentFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(studentEClass, STUDENT__ADDRESS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getStudent_Address(), this.getAddress(), null, "address", null, 0, 1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAddress_PostalCode(), ecorePackage.getEInt(), "postalCode", null, 0, 1, Address.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
